---
name: css
description: Reference for writing modern, robust, and efficient CSS. Covers container queries, modern color spaces (oklch, display-p3), scroll-driven animations, view transitions, anchor positioning, cascade layers, popover/dialog APIs, and progressive enhancement patterns.
---
...
0. BEST: Fetch [https://web-platform-dx.github.io/web-features-explorer/groups/](https://web-platform-dx.github.io/web-features-explorer/groups/) and find the feature in there, then fetch its detail page.
...
- [Adam Argyle's CascadiaJS 2025 Deck](https://cascadiajs-2025.netlify.app/) - Latest CSS features
